    ...
    <main className="min-h-screen px-5 py-8 sm:px-8 lg:px-12">
      <section className="mx-auto flex max-w-6xl flex-col gap-8">
        ...
        <section className="grid gap-4 lg:grid-cols-[0.95fr_1.05fr]">
          <div className="rounded-[1.5rem] border border-black/10 bg-white/70 p-5 text-sm leading-7 text-black/60 shadow-soft">
            <h2 className="mb-3 font-serif text-2xl text-black/85">入店規章</h2>
          ...
          <details className="rounded-[1.5rem] border border-black/10 bg-white/55 p-5 text-sm leading-7 text-black/55 shadow-soft open:bg-white/70">
            <summary className="cursor-pointer font-serif text-2xl text-black/85">更多注意事項</summary>
